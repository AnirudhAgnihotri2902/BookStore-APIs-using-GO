...
func main() {
    ...
    http.HandleFunc("/delbookbyname", DelBookByName)
    http.HandleFunc("/getbookbyauthor", GetBookByAuthor)
    http.HandleFunc("/getallbooks", GetAllBook)
    http.HandleFunc("/getbookbypublishdate", GetBookByPublishDate)
